...
Tools: `roots_list`, `root_add`, `root_remove`, `index_update`, `index_status`, `metrics_get`, `search_text`, `search_regex`, `files_find`, and `file_read`.
